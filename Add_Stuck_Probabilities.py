...
def add_stuck_probabilities(scale_size):
    loadloc = 'middle'
    sigma = 0.35
    max_steps = 5000
    rolling = True
    ...
    YoavSimResults_timeout = (x for x in enumerate(YoavSimResults_t[700:900]) if
    ...
    for sim in YoavSimResults_timeout:
        ...
        stucking_densities.append(math.floor(stucking_density * 10) / 10)
