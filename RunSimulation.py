...
def sim_func(tilescale):
    ...
    #     number_of_iterations)+'iterations'
    cube_densities = [100, 200, 225, 250, 275, 300]  # ,150, 400]
    ...
    for cube_density in cube_densities:
        ...
        for video_number in misc.file_names_by_density(cube_density):
            ...
            for iteration in range(1, number_of_iterations+1):
                print('scale = ' + str(tilescale) + ',video number = ' + video_number +
                ...
                # sim = TiledGridSimulation(pickle_file_name, seed=int(seed),
                # num_stones=cube_density,
                #                          tile_scale=tilescale, is_stuckable=False)
                ...
                try:
                    ...
                    ResultsObject.append(SimulationResults(load_path, load_trajectory_length,
                                                           load_time, where_out, tilescale,
                                                           cube_density, video_number=video_number))
